...
# USER_PROMPT = "use the provided guidelines which is provided as a PDF file and reflect whether the image provided violates the guidelines, focus only guidelines that concern the logo"