...
parser.add_argument("-m", "--model", required=True, type=str, choices=["gemini-2.5-flash-preview-04-17", "gemini-2.0-flash", "gemini-2.5-pro-preview-03-25", "gemini-2.5-pro-exp-03-25", "gemini-1.5-flash", "gemini-2.5-pro-preview-05-06"], help="path to input guidelines pdf file file")
